  ...
  <ul class="list-group list-group-flush sidebar_menu">
    ...
    <li class="{{ setActive('/empleados/nominas') }} dropdownMenu">
      ...
      <div class="dropdownContent">
        <ul>
          <ol data-route="/empleados/nominas" class="{{ setActiveSub('/empleados/nominas') }}" onclick="javascript:location.href='{{url('/empleados/nominas')}}'">
    ...
    <li class="{{ setActive('/empleados/ausentismos') }} dropdownMenu">
      ...
      <div class="dropdownContent">
        <ul>
          <ol data-route="/empleados/ausentismos" class="{{ setActiveSub('/empleados/ausentismos') }}" onclick="javascript:location.href='{{url('/empleados/ausentismos')}}'">
            <a href="{{url('/empleados/ausentismos')}}">Listado</a>
          </ol>
          <ol data-route="/empleados/comunicaciones" class="{{ setActiveSub('/empleados/comunicaciones') }}" onclick="javascript:location.href='{{url('/empleados/comunicaciones')}}'">
            <a href="{{url('/empleados/comunicaciones')}}">Comunicaciones</a>
          </ol>
          <ol data-route="/empleados/certificados" class="{{ setActiveSub('/empleados/certificados') }}" onclick="javascript:location.href='{{url('/empleados/certificados')}}'">
    ...
    <li class="{{ setActive('/empleados/consultas') }} dropdownMenu">
      ...
      <div class="dropdownContent">
        <ul>
          <ol data-route="empleados.consultas.medicas" class="{{ setActiveSub('empleados.consultas.medicas') }}" onclick="javascript:location.href='{{url('/empleados/consultas/medicas')}}'">
            <a href="{{url('/empleados/consultas/medicas')}}">Médicas</a>
          </ol>
          <ol data-route="empleados.consultas.enfermeria" class="{{ setActiveSub('empleados.consultas.enfermeria') }}" onclick="javascript:location.href='{{url('/empleados/consultas/enfermeria')}}'">
    ...
    <li class="{{ setActive('/empleados/covid') }} dropdownMenu">
      ...
      <div class="dropdownContent">
        <ul>
          <ol data-route="/empleados/covid/testeos" class="{{ setActiveSub('/empleados/covid/testeos') }}" onclick="javascript:location.href='{{url('/empleados/covid/testeos')}}'">
            <a href="{{url('/empleados/covid/testeos')}}">Testeos</a>
          </ol>
          <ol data-route="/empleados/covid/vacunas" class="{{ setActiveSub('/empleados/covid/vacunas') }}" onclick="javascript:location.href='{{url('/empleados/covid/vacunas')}}'">
    ...
    <li class="{{ setActive('/empleados/medicamentos') }} dropdownMenu">
      ...
      <div class="dropdownContent">
        <ul>
          <ol data-route="/empleados/medicamentos" class="{{ setActiveSub('/empleados/medicamentos') }}" onclick="javascript:location.href='{{url('/empleados/medicamentos')}}'">
            <a href="{{url('/empleados/medicamentos')}}">Listado</a>
          </ol>
          <ol data-route="/empleados/medicamentos_movimientos" class="{{ setActiveSub('/empleados/medicamentos_movimientos') }}" onclick="javascript:location.href='{{url('/empleados/medicamentos_movimientos')}}'">
    ...
    <li class="{{ setActive('/empleados/preocupacionales') }} dropdownMenu">
      ...
      <div class="dropdownContent">
        <ul>
          <ol data-route="/empleados/preocupacionales" class="{{ setActiveSub('/empleados/preocupacionales') }}" onclick="javascript:location.href='{{url('/empleados/preocupacionales')}}'">
    ...
    <li class="{{ setActive('/empleados/cuenta') }} dropdownMenu">
      ...
      <div class="dropdownContent">
        <ul>
          <ol data-route="/empleados/cuenta" class="{{ setActiveSub('/empleados/cuenta') }}" onclick="javascript:location.href='{{url('/empleados/cuenta')}}'">
            <a href="{{url('/empleados/cuenta')}}">Mi cuenta</a>
          </ol>
          <ol data-route="/empleados/liquidacion" class="{{ setActiveSub('/empleados/liquidacion') }}" onclick="javascript:location.href='{{url('/empleados/liquidacion')}}'">
