<div class="bg_sidebar border-right" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush sidebar_menu">
        ...
        <li class="{{ setActive('/admin/receta-financiadores-anulacion') }} menu_sin_sub_menu">
            <a href="{{ route('admin.receta_financiadores_anulacion.index') }}"
                class="list-group-item list-group-item-action sidebar_item">
                <i class="fas fa-ban"></i>
                <span>Recetas - Anulación</span>
            </a>
        </li>
        ...
        <li class="{{ setActive('/admin/reportes') }} dropdownMenu">
            ...
            <div class="dropdownContent">
                <ul>
                    ...
                    <ol data-route="reportes_preocupacionales"
                        class="{{ setActiveSub('reportes_preocupacionales') }}">
                        <a href="{{ url('/admin/reportes_preocupacionales') }}">Est. Médicos Complementarios</a>
                    </ol>

                    <ol data-route="reportes_tareas_adecuadas"
                        class="{{ setActiveSub('reportes_tareas_adecuadas') }}">
