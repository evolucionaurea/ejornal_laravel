...
@section('title', 'Admin - Editar financiador anulación')
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="cabecera mb-3">
                <h2 class="h4 font-weight-bold mb-1">Editar Financiador - Anulación</h2>
            </div>
            ...
            <div class="tarjeta">
                <div class="card-body">
                    <form action="{{ route('admin.receta_financiadores_anulacion.update', $financiador->id) }}"
                        method="POST">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            ...
                            <input type="number" id="id_financiador" name="id_financiador" min="1"
                                ...
                                value="{{ old('id_financiador', $financiador->id_financiador) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nombre" name="nombre" maxlength="200"
                                ...
                                value="{{ old('nombre', $financiador->nombre) }}" required>
                            @error('nombre')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn-ejornal btn-ejornal-base mr-2">Guardar cambios</button>
