...
@section('content')
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="tarjeta">
                <form id="form_create_user_por_admin" action="{{ action('AdminUserController@store') }}"
                    ...
                    <div class="form-row align-items-center">
                        ...
                        <div class="form-group col-md-4 select_contratacion_users">
                            ...
                            <select name="contratacion" class="form-control form-control-sm">
                                <option value="0" {{ old('contratacion', '0') == '0' ? 'selected' : '' }}>
                                    --Seleccionar--</option>
                                <option value="1" {{ old('contratacion') == '1' ? 'selected' : '' }}>Efectivo</option>
                                <option value="2" {{ old('contratacion') == '2' ? 'selected' : '' }}>Eventual</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-md-4 select_permiso_edicion_fichadas">
                            ...
                            <select name="permiso_edicion_fichada" class="form-control form-control-sm">
                                <option value="0" {{ old('permiso_edicion_fichada', '0') == '0' ? 'selected' : '' }}>
                                    No</option>
                                <option value="1" {{ old('permiso_edicion_fichada') == '1' ? 'selected' : '' }}>Si
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-md-3 cliente_original">
                            ...
                            <br>
                            <select class="form-control form-control-sm" id="select_cliente_original"
                        ...
                        <div class="form-group col-md-2 mostrar_personal_interno">
                            <div class="form-check">
                                <input name="personal_interno" class="form-check-input" type="checkbox"
                                    id="personal_interno_check">
                        ...
                        @if (count($clientes) > 0 && !empty($clientes))
                            ...
                            <div class="form-group col-md-2 mostrar_permitir_fichada">
                                ...
                                <select name="fichar" class="form-control form-control-sm">
                                    <option value="1" {{ old('fichar', '1') == '1' ? 'selected' : '' }}>Si</option>
                                    <option value="0" {{ old('fichar') == '0' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>

                            <div class="form-group col-md-12 mostrar_observaciones">
                                <label>Observaciones</label>
                                <textarea class="form-control" rows="2" name="observaciones">{{ old('observaciones') }}</textarea>
                            </div>
                            ...
                            <div class="form-group col-md-12 liquidacion_onedrive_creacion_users">
                                ...
                                <textarea class="form-control" rows="2" name="onedrive">{{ old('onedrive') }}</textarea>
                            </div>
                        @else
                        ...
                        <div class="col-12">
                            <button class="btn-ejornal btn-ejornal-base" type="submit" name="button">Crear
                                usuario</button>
                        </div>
