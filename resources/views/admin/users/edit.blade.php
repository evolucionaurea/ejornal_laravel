                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-lg-4 col-md-6 col-sm-12 mostrar_personal_interno">
                        <div class="form-check">
                            <input type="hidden" class="personal_interno_viene_de_base" value="{{$user->personal_interno}}">
                            <input class="check_personal_interno" name="personal_interno" class="form-check-input" type="checkbox" id="gridCheck">
