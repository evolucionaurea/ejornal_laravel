...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <div class="cabecera">
            <h2>Edición de motivos para la agenda</h2>
            <p>Aquí podrá editar la información de un motivo</p>
        ...
        <div class="tarjeta">
            <form action="{{action('AdminAgendaMotivoController@update', $motivo->id)}}" accept-charset="UTF-8"
                method="post">
                {{ csrf_field() }}
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input name="nombre" type="text" class="form-control form-control-sm"
                            value="{{$motivo->nombre}}" placeholder="" required>
                    </div>
                </div>
