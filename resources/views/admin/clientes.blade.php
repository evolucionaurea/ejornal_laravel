    ...
    <div id="page-content-wrapper">
        ...
        <div class="cabecera">
            ...
            <div class="cabecera_acciones">
                <a class="btn-ejornal btn-ejornal-base" href="{{route('clientes.create')}}"><i class="fas fa-plus-circle"></i> Nuevo cliente</a>
                <a data-toggle="modal" data-target="#cargar_clientes_excel" class="btn-ejornal btn-ejornal-success" href="#"><i class="fas fa-file-excel"></i>Carga masiva</a>
            </div>
        </div>
