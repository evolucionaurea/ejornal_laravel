...
<div class="d-flex" id="wrapper">
	...
	<div id="page-content-wrapper">
		...
		<div class="cabecera">
			...
			<p>Aquí puedes ver el listado de todos los pedidos y stock de medicamentos que han realizado los empleados de eJornal en cada cliente.</p>
		</div>
		...
		<div class="tarjeta">
			<table data-table="movimientos" class="table table-striped table-hover table-sm table-bordered">
				<thead>
					<tr>
						<th>Medicamento</th>
						<th>Cliente</th>
				...
				<tbody>
					...
					<tr>
						...
						<td>{{$stock->cliente}}</td>
						<td>{{$stock->user}}</td>
						<td class="text-center">{{ ($stock->ingreso != 0 && $stock->ingreso != null) ? $stock->ingreso : "" }}</td>
						<td class="text-center">{{ ($stock->suministrados != 0 && $stock->suministrados != null) ? $stock->suministrados : "" }}</td>
						<td class="text-center">{{ ($stock->egreso != 0 && $stock->egreso != null) ? $stock->egreso : "" }}</td>
			...
			<div class="modal-body">
				...
				<div class="card mb-4">
					...
					<div class="card-body">
						...
						<p class="card-text">Descarga este excel modelo. Complétalo con los campos solicitados y súbelo en el paso 2</p>
