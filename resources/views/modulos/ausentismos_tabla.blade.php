<div data-toggle="busqueda-fecha" class="d-flex flex-wrap">
	...
	<div class="d-flex flex-wrap col-md-8 align-items-center">
		...
		<div class="mb-1 col-md-6">
			<input name="search" class="form-control form-control-sm" placeholder="Buscar..."
...
<table class="table table-striped table-hover table-sm tabla_ausentismos">
	...
	<thead>
		<tr>
			...
			<th>Total días <i class="fa fa-question-circle fa-fw"
					data-swal="Se calcula desde la fecha de inicio hasta la fecha final"></i></th>
