    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="cabecera">
                ...
                @else
                    <div class="small text-muted"><i>Debe fichar para poder agregar un nuevo movimiento de medicamento.</i>
                    </div>
                @endif
            ...
            <div class="tarjeta">
                ...
                <div data-toggle="busqueda-filtros" class="row align-items-center">
                    ...
                    <div class="col-lg-6 form-group">
                        ...
                        <button data-toggle="export" data-href="{{ url('empleados/medicamentos_movimientos/exportar') }}"
