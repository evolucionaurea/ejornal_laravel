...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <div class="tarjeta">
            <form action="{{action('EmpleadosCovidTesteoController@store')}}" accept-charset="UTF-8" method="post">
            @csrf
            <div class="form-row">
              <div class="form-group col-md-3">
                ...
                <div class="form-group col-md-12">
                    ...
                    <textarea name="laboratorio" class="form-control" rows="3"></textarea>
                </div>
            </div>
            <button class="btn-ejornal btn-ejornal-base" type="submit" name="button">Guardar testeo</button>
            </form>
        </div>
