...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <div class="tarjeta">
            <form action="{{action('EmpleadosCovidVacunasController@update', $vacuna->id)}}" accept-charset="UTF-8" method="post">
                {{ csrf_field() }}
                ...
                <div class="form-row">
                  <div class="form-group col-md-3">
                    ...
                    <div class="form-group col-md-3">
                        <label>Fecha</label>
                        <input id="data_picker_gral" name="fecha" type="datetime" class="form-control"
                        value="{{ (!empty($vacuna->fecha)) ? date('d/m/Y',strtotime($vacuna->fecha)) : "" }}">
                    </div>
                    <div class="form-group col-md-3">
                        <label>institucion</label>
                        <textarea required name="institucion" class="form-control" rows="3">{{$vacuna->institucion}}</textarea>
                    </div>
