...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <div class="tarjeta">
            <form id="form_guardar_consulta_medica" action="{{action('EmpleadoConsultaMedicaController@store')}}" accept-charset="UTF-8" method="post">
            @csrf
            <div class="form-row">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <textarea name="anamnesis" required class="form-control" rows="3">{{ old("anamnesis") }}</textarea>
                </div>
                <div class="form-group col-md-4">
                    <label>Tratamiento <span style="color: red;">*</span></label>
                    <textarea name="tratamiento" required class="form-control" rows="3">{{ old("tratamiento") }}</textarea>
                </div>
                <div class="form-group col-md-4">
            ...
            <button id="guarda_consulta" class="btn-ejornal btn-ejornal-base" type="submit" name="button">Guardar consulta médica</button>
            </form>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="alert alert-light" role="alert">
                            ...
                            <hr>
                            <a id="consulta_medica_crear_ok" type="button" class="btn-ejornal btn-ejornal-success">Aceptar</a>
