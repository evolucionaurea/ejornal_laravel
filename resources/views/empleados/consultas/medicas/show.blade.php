	...
	<div id="page-content-wrapper">
		...
		<div class="cabecera">
			...
			<div class="cabecera_acciones">
				<a class="btn-ejornal btn-ejornal-base" href="{{url('empleados/consultas/medicas')}}"><i
		...
		<div class="tarjeta">
					...
					<div class="card mt-2 mb-3">
						<div class="card-body">
							<h5 class="card-title text_primary">
								<b>Fecha:</b> {{ (!empty($consulta_medica->fecha)) ?
								...
								<div class="col-md-6 col-sm-12">
									<ul class="list-group list-group-flush">
										...
										<li class="list-group-item">
											...
											{{ (!empty($consulta_medica->created_at)) ? date('d/m/Y
			...
			<a href="{{route('empleados.consultas.medicas')}}"><i class="fa fa-angle-double-left fa-fw"></i> Volver al
				listado</a>
			@endif
		</div>
