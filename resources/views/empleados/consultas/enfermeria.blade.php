...
<div class="d-flex" id="wrapper">
	...
	<div id="page-content-wrapper">
		...
		<div class="cabecera">
			...
			&& auth()->user()->id_especialidad == 2)
			<div class="cabecera_acciones">
				<a class="btn-ejornal btn-ejornal-base" href="{{route('enfermeria.create')}}"><i
						class="fas fa-plus-circle"></i> Nueva consulta de enfermería</a>
			</div>
			@endif
		</div>
