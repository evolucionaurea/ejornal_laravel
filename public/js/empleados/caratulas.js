...
/***/ "./resources/js/empleados/caratulas.js":
/*!*********************************************!*\
  !*** ./resources/js/empleados/caratulas.js ***!
  \*********************************************/
/*! no exports provided */
    ...
    datatable_options: {
      ...
      columns: [{
        ...
        render: function render(v) {
          ...
          return "\n\t\t\t\t\t\t\t<div>".concat(v.nombre, "</div>\n\t\t\t\t\t\t\t<div class=\"small\">DNI: ").concat(v.dni, "</div>\n\t\t\t\t\t\t\t<div class=\"small\">Legajo: ").concat(v.legajo ? v.legajo : '<i>[Sin legajo]</i>', "</div>\n\t\t\t\t\t\t\t<span class=\"badge badge-").concat(v.estado == 1 ? 'success' : 'danger', "\">").concat(v.estado == 1 ? 'Activo' : 'Inactivo', "</span>\n\t\t\t\t\t\t\t");
        }
      }, {
        ...
        render: function render(v) {
          ...
          var patologias = [];
          v.patologias.map(function (p) {
            patologias.push("<span class=\"badge badge-dark p-2 mr-1 mb-1\">".concat(p.nombre, "</span>"));
          });
        ...
        orderable: false,
        render: function render(v) {
          return "\n\t\t\t\t\t\t\t<div>Peso: ".concat(v.peso, " kg.</div>\n\t\t\t\t\t\t\t<div>Altura: ").concat(v.altura, " cm.</div>\n\t\t\t\t\t\t\t<div>IMC: ").concat(v.imc, "</div>\n\t\t\t\t\t\t");
        }
      }, {
        data: 'ultima_caratula',
        name: 'ultima_caratula',
        ...
        render: function render(v, type, row, meta) {
          ...
          return "\n\t\t\t\t\t\t<div class=\"acciones_tabla justify-content-end\">\n\t\t\t\t\t\t\t<a title=\"Editar Car\xE1tula\" href=\"caratulas/edit/".concat(v.id, "\">\n\t\t\t\t\t\t\t\t\t<i class=\"fas fa-pencil\"></i>\n\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\t\t<a title=\"Ver Historial de Cambios\" href=\"caratulas/").concat(v.id, "\">\n\t\t\t\t\t\t\t\t\t<i class=\"fas fa-history\"></i>\n\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t</div>");
        }
      }]
    }
  });
...
/***/ 32:
/*!***************************************************!*\
  !*** multi ./resources/js/empleados/caratulas.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\ela_g\Herd\ejornal_laravel\resources\js\empleados\caratulas.js */"./resources/js/empleados/caratulas.js");
