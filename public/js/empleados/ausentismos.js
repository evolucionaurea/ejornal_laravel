...
/***/ "./resources/js/empleados/ausentismos.js":
/*!***********************************************!*\
  !*** ./resources/js/empleados/ausentismos.js ***!
  \***********************************************/
/*! no exports provided */
...
$(function () {
  ...
  new _classes_Tablas_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
    ...
    datatable_options: {
      ...
      columns: [{
        ...
        className: 'align-middle',
        render: function render(v) {
          var _v$trabajador_dni;
          var output = "\n\t\t\t\t\t\t<div>\n\t\t\t\t\t\t\t<a href=\"".concat(v.trabajador_perfil_url, "\" target=\"_blank\" class=\"text-dark\">").concat(v.trabajador_nombre, "</a>\n\t\t\t\t\t\t</div>");
          output += "<div class=\"small\">DNI: ".concat((_v$trabajador_dni = v.trabajador_dni) !== null && _v$trabajador_dni !== void 0 ? _v$trabajador_dni : '<span class="small text-muted font-italic">[no cargado]</span>', "</div>");
          if (v.id_cliente != v.trabajador_cliente) {
            output += "<span class=\"badge badge-dark\">transferido</span>";
          } else {
            output += "<span class=\"badge badge-".concat(v.trabajador_estado == 1 ? 'success' : 'danger', "\">").concat(v.trabajador_estado == 1 ? 'activo' : 'inactivo', "</span>");
          }
          return output;
        }
      }, {
        ...
        render: function render(v, type, row, meta) {
          ...
          var regreso_trabajar = null;
          var hoy;
          var mostrar_extension;
          if (v.fecha_final == null) {
            regreso_trabajar = null;
            mostrar_extension = true;
          } else {
            var str = v.fecha_final;
            ...
            var limiteSuperior = new Date(hoy.getTime() + 72 * 60 * 60 * 1000);
          ...
          return "\n\t\t\t\t\t\t\t<div class=\"acciones_tabla justify-content-end\">\n\t\t\t\t\t\t\t\t".concat(mostrar_extension == true ? "\n\t\t\t\t\t\t\t\t\t<button class=\"extension_de_licencia\" title=\"extension de licencia\" data-toggle=\"modal-extension-licencia\" data-id=\"".concat(v.id, "\" >\n\t\t\t\t\t\t\t\t\t\t<i title=\"extension de licencia\" class=\"fas fa-forward\"></i>\n\t\t\t\t\t\t\t\t\t</button>\n\t\t\t\t\t\t\t\t\t") : '', "\n\n\t\t\t\t\t\t\t\t<a title=\"Historial\" href=\"ausentismos/").concat(v.id, "\">\n\t\t\t\t\t\t\t\t\t<i title=\"Historial\" class=\"fas fa-book\"></i>\n\t\t\t\t\t\t\t\t</a>\n\n\t\t\t\t\t\t\t\t").concat(v.id_cliente == v.trabajador_cliente ? "\n\n\t\t\t\t\t\t\t\t\t<a title=\"Comunicaciones\" href=\"comunicaciones/".concat(v.id, "\" class=\"btn-label\">\n\t\t\t\t\t\t\t\t\t\t<i title=\"Comunicaciones\" class=\"fas fa-bullhorn\"></i>\n\t\t\t\t\t\t\t\t\t\t<span>(").concat(v.comunicaciones_count, ")</span>\n\t\t\t\t\t\t\t\t\t</a>\n\n\t\t\t\t\t\t\t\t\t<a title=\"Certificados\" href=\"documentaciones/").concat(v.id, "\" class=\"btn-label\">\n\t\t\t\t\t\t\t\t\t\t<i title=\"Certificados\" class=\"fas fa-files-medical\"></i>\n\t\t\t\t\t\t\t\t\t\t<span>(").concat(v.documentaciones_count, ")</span>\n\t\t\t\t\t\t\t\t\t</a>\n\n\t\t\t\t\t\t\t\t\t<a title=\"Editar\" href=\"ausentismos/").concat(v.id, "/edit\">\n\t\t\t\t\t\t\t\t\t\t<i class=\"fas fa-pencil\"></i>\n\t\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\t\t\t<button data-toggle=\"delete\" data-id=\"").concat(v.id, "\" title=\"Eliminar\" >\n\t\t\t\t\t\t\t\t\t\t<i class=\"fas fa-trash\"></i>\n\t\t\t\t\t\t\t\t\t</button>") : '', "\n\t\t\t\t\t\t\t</div>");
        }
      }]
    }
  });
  $('[data-table="ausentismos"]').on('click', '[data-toggle="modal-extension-licencia"]', function (btn) {
    var ausentismo_id = $(btn.currentTarget).attr('data-id');
...
/***/ 36:
/*!*****************************************************!*\
  !*** multi ./resources/js/empleados/ausentismos.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\ela_g\Herd\ejornal_laravel\resources\js\empleados\ausentismos.js */"./resources/js/empleados/ausentismos.js");
