...
/***/ "./resources/js/empleados/covid/vacunas.js":
/*!*************************************************!*\
  !*** ./resources/js/empleados/covid/vacunas.js ***!
  \*************************************************/
/*! no exports provided */
...
$(function () {
  new _classes_Tablas_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
    ...
    render_row: function render_row(vacuna) {
      return $("\n\t\t\t<tr data-id=\"".concat(vacuna.id, "\">\n\t\t\t\t<td>").concat(vacuna.nombre, "</td>\n\t\t\t\t<td>").concat(vacuna.tipo, "</td>\n\t\t\t\t<td>").concat(vacuna.fecha, "</td>\n\n\t\t\t\t<td>").concat(vacuna.institucion, "</td>\n\n\t\t\t\t<td class=\"acciones_tabla\" scope=\"row\">\n\t\t\t\t\t<a title=\"Ver\" href=\"vacunas/").concat(vacuna.id, "/edit\">\n\t\t\t\t\t\t<i class=\"fas fa-pencil\"></i>\n\t\t\t\t\t</a>\n\n\t\t\t\t\t<button data-toggle=\"delete\" data-id=\"").concat(vacuna.id, "\" title=\"Eliminar\" type=\"submit\">\n\t\t\t\t\t\t<i class=\"fas fa-trash\"></i>\n\t\t\t\t\t</button>\n\n\t\t\t\t</td>\n\t\t\t</tr>"));
    }
  });
});
...
module.exports = __webpack_require__(/*! C:\Users\ela_g\Herd\ejornal_laravel\resources\js\empleados\covid\vacunas.js */"./resources/js/empleados/covid/vacunas.js");
