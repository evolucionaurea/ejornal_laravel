...
/***/ "./resources/js/empleados/covid/testeos.js":
/*!*************************************************!*\
  !*** ./resources/js/empleados/covid/testeos.js ***!
  \*************************************************/
/*! no exports provided */
...
$(function () {
  new _classes_Tablas_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
    ...
    render_row: function render_row(testeo) {
      return $("\n\t\t\t<tr data-id=\"".concat(testeo.id, "\">\n\t\t\t\t<td>").concat(testeo.nombre, "</td>\n\t\t\t\t<td>").concat(testeo.tipo, "</td>\n\t\t\t\t<td>").concat(testeo.fecha, "</td>\n\t\t\t\t<td><span class=\"tag_ejornal tag_ejornal_").concat(testeo.resultado == 'negativo' ? 'danger' : 'success', "\">").concat(testeo.resultado, "</span></td>\n\t\t\t\t<td>").concat(testeo.laboratorio, "</td>\n\n\t\t\t\t<td class=\"acciones_tabla\" scope=\"row\">\n\t\t\t\t\t<a title=\"Ver\" href=\"testeos/").concat(testeo.id, "/edit\">\n\t\t\t\t\t\t<i class=\"fas fa-pencil\"></i>\n\t\t\t\t\t</a>\n\n\t\t\t\t\t<button data-toggle=\"delete\" data-id=\"").concat(testeo.id, "\" title=\"Eliminar\" type=\"submit\">\n\t\t\t\t\t\t<i class=\"fas fa-trash\"></i>\n\t\t\t\t\t</button>\n\n\t\t\t\t</td>\n\t\t\t</tr>"));
    }
  });
});
...
module.exports = __webpack_require__(/*! C:\Users\ela_g\Herd\ejornal_laravel\resources\js\empleados\covid\testeos.js */"./resources/js/empleados/covid/testeos.js");
