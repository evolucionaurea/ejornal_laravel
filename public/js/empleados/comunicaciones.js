...
/***/ "./resources/js/empleados/comunicaciones.js":
/*!**************************************************!*\
  !*** ./resources/js/empleados/comunicaciones.js ***!
  \**************************************************/
/*! no exports provided */
    ...
    datatable_options: {
      ...
      columns: [{
        ...
        render: function render(row) {
          return "\n\t\t\t\t\t\t\t<div>".concat(row.ausentismo.trabajador.nombre, "</div>\n\t\t\t\t\t\t\t<div class=\"small text-muted\">DNI: ").concat(row.ausentismo.trabajador.dni, "</div>\n\t\t\t\t\t\t");
        }
      }, {
        data: 'tipo',
        className: 'align-middle',
        ...
        orderable: false,
        render: function render(archivos) {
          var baseUrl = '/comunicaciones/archivo';
          if (archivos.length > 0) {
            var dropdownItems = archivos.map(function (archivo) {
              return "<li class=\"dropdown-item\" style=\"width:auto\">\n\t\t\t\t\t\t\t\t\t<a class=\"small\" href=\"".concat(baseUrl, "/").concat(archivo.id_comunicacion, "/").concat(archivo.hash_archivo, "\" target=\"_blank\">\n\t\t\t\t\t\t\t\t\t   ").concat(archivo.archivo, "\n\t\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\t\t</li>");
            }).join('');
        ...
        render: function render(v) {
          ...
          return "<span class=\"badge badge-".concat(v.estado == 1 ? 'success' : 'danger', "\">").concat(v.estado == 1 ? 'Activo' : 'Inactivo', "</span>");
        }
      }, {
        data: 'descripcion',
        className: 'align-middle small',
        ...
        render: function render(v, type, row, meta) {
          ...
          return '';
          return "\n\t\t\t\t\t\t<a href=\"empleados/ausentismo/".concat(v.id_ausentismo, "\" class=\"btn btn-tiny btn-info\">\n\t\t\t\t\t\t\t<i class=\"fal fa-angle-double-right fa-fw\"></i> Ver Ausentismo\n\t\t\t\t\t\t</a>");
        }
      }]
    }
  });
...
/***/ 46:
/*!********************************************************!*\
  !*** multi ./resources/js/empleados/comunicaciones.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\ela_g\Herd\ejornal_laravel\resources\js\empleados\comunicaciones.js */"./resources/js/empleados/comunicaciones.js");
