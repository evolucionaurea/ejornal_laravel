...
/***/ "./resources/js/empleados/tareas_livianas.js":
/*!***************************************************!*\
  !*** ./resources/js/empleados/tareas_livianas.js ***!
  \***************************************************/
/*! no exports provided */
    ...
    datatable_options: {
      ...
      columns: [{
        ...
        render: function render(v) {
          ...
          var output = "\n\t\t\t\t\t\t<div>\n\t\t\t\t\t\t\t<a href=\"".concat(v.trabajador_perfil_url, "\" target=\"_blank\" class=\"text-dark\">").concat(v.trabajador.nombre, "</a>\n\t\t\t\t\t\t</div>");
          if (v.id_cliente != v.trabajador.id_cliente) {
            output += "<span class=\"badge badge-dark\">transferido</span>";
          } else {
            output += "<span class=\"badge badge-".concat(v.trabajador.estado == 1 ? 'success' : 'danger', "\">").concat(v.trabajador.estado == 1 ? 'activo' : 'inactivo', "</span>");
          }
          return output;
        }
      }, {
        ...
        render: function render(v) {
          if (v.fecha_final == null) {
            ...
            var _str$split = str.split('/'),
              ...
              mes = _str$split2[1],
              anio = _str$split2[2];
            var regreso_trabajar = new Date(+anio, mes - 1, +dia);
            var hoy = new Date();
        ...
        render: function render(v, type, row, meta) {
          ...
          return "\n\t\t\t\t\t\t\t<div class=\"acciones_tabla\">\n\t\t\t\t\t\t\t\t".concat(mostrar_extension == true ? "\n\t\t\t\t\t\t\t\t\t<button\n\t\t\t\t\t\t\t\t\t\tclass=\"extension_de_licencia_adecuada\"\n\t\t\t\t\t\t\t\t\t\ttitle=\"extension de licencia adecuada\"\n\t\t\t\t\t\t\t\t\t\tdata-toggle=\"modal\"\n\t\t\t\t\t\t\t\t\t\tdata-target=\"#extensionLicenciaAdecuadaModal\"\n\t\t\t\t\t\t\t\t\t\tdata-info=\"".concat(v.id, "\"\n\t\t\t\t\t\t\t\t\t>\n\t\t\t\t\t\t\t\t\t\t<i title=\"extension de licencia\" class=\"fas fa-forward\"></i>\n\t\t\t\t\t\t\t\t\t</button>\n\t\t\t\t\t\t\t\t\t") : '', "\n\t\t\t\t\t\t\t\t<a title=\"Comunicaciones\" href=\"comunicaciones_livianas/").concat(v.id, "\">\n\t\t\t\t\t\t\t\t\t<i title=\"Comunicaciones\" class=\"fas fa-bullhorn\"></i>\n\t\t\t\t\t\t\t\t</a>\n\n\t\t\t\t\t\t\t\t<a title=\"Certificados\" href=\"documentaciones_livianas/").concat(v.id, "\">\n\t\t\t\t\t\t\t\t\t<i title=\"Certificados\" class=\"fas fa-files-medical\"></i>\n\t\t\t\t\t\t\t\t</a>\n\n\t\t\t\t\t\t\t\t<a title=\"Historial\" href=\"tareas_livianas/").concat(v.id_trabajador, "\">\n\t\t\t\t\t\t\t\t\t<i title=\"Historial\" class=\"fas fa-book\"></i>\n\t\t\t\t\t\t\t\t</a>\n\n\t\t\t\t\t\t\t\t").concat(v.id_cliente == v.trabajador.id_cliente ? "<a title=\"Editar\" href=\"tareas_livianas/".concat(v.id, "/edit\">\n\t\t\t\t\t\t\t\t\t\t\t<i class=\"fas fa-pencil\"></i>\n\t\t\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\t\t\t\t<button data-toggle=\"delete\" data-id=\"").concat(v.id, "\" title=\"Eliminar\" type=\"submit\">\n\t\t\t\t\t\t\t\t\t\t\t<i class=\"fas fa-trash\"></i>\n\t\t\t\t\t\t\t\t\t\t</button>") : '', "\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t");
        }
      }]
    },
    server_side: true
  });
  $('.tabla_tareas_livianas').on("click", '.extension_de_licencia_adecuada', function () {
    var id_tarea_liviana = $(this).attr("data-info");
...
/***/ 43:
/*!*********************************************************!*\
  !*** multi ./resources/js/empleados/tareas_livianas.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\ela_g\Herd\ejornal_laravel\resources\js\empleados\tareas_livianas.js */"./resources/js/empleados/tareas_livianas.js");
