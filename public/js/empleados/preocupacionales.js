...
/***/ "./resources/js/empleados/preocupacionales.js":
/*!****************************************************!*\
  !*** ./resources/js/empleados/preocupacionales.js ***!
  \****************************************************/
/*! no exports provided */
...
$(function () {
    ...
    datatable_options: {
      ...
      columns: [{
        ...
        render: function render(v) {
          ...
          return "\n\t\t\t\t\t\t\t<div>".concat(v.trabajador.nombre, "</div>\n\t\t\t\t\t\t\t<div class=\"small\">DNI: ").concat(v.trabajador.dni, "</div>\n\t\t\t\t\t\t\t<div class=\"small\">Tel: ").concat(v.trabajador.telefono, "</div>\n\t\t\t\t\t\t\t").concat(v.id_cliente != v.trabajador_cliente ? '<span class="badge badge-dark">transferido</span>' : '', "\n\t\t\t\t\t\t");
        }
      }, {
        data: null,
        name: 'nominas.legajo',
        ...
        render: function render(v) {
          ...
          return "\n\t\t\t\t\t\t\t<div>".concat(v.trabajador_legajo, "</div>\n\t\t\t\t\t\t");
        }
      }, {
        data: 'fecha',
        className: 'align-middle',
      ...
      },*/
      {
        ...
        orderable: false,
        className: 'align-middle',
        render: function render(archivos, type, row, meta) {
          ...
          var buttons = '';
          archivos.map(function (archivo, k) {
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          case 0:
            ...
            _context.p = 1;
            _context.n = 2;
            return axios.post("preocupacionales/completar/".concat(id));
          case 2:
            response = _context.v;
  ...
  $('[data-toggle="busqueda-fecha"]').on('change', '[name="vencimiento"]', function (select) {
  ...
  $('[data-toggle="busqueda-fecha"] [data-toggle="clear"]').click(function (btn) {
...
module.exports = __webpack_require__(/*! C:\Users\ela_g\Herd\ejornal_laravel\resources\js\empleados\preocupacionales.js */"./resources/js/empleados/preocupacionales.js");
