...
/***/ "./resources/js/empleados/comunicaciones_livianas.js":
/*!***********************************************************!*\
  !*** ./resources/js/empleados/comunicaciones_livianas.js ***!
  \***********************************************************/
/*! no exports provided */
...
$(function () {
  new _classes_Tablas_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
    ...
    render_row: function render_row(comunicacion) {
      // Formatear la fecha
      ...
      var trabajador = "<div>".concat(comunicacion.nombre, "</div>");
      var status = "<span class=\"tag_ejornal tag_ejornal_".concat(comunicacion.estado == 1 ? 'success' : 'danger', "\">").concat(comunicacion.estado == 1 ? 'Activo' : 'Inactivo', "</span>");
      ...
      if (comunicacion.tarea_liviana.trabajador.deleted_at == null) {
        trabajador = "<div><a href=\"".concat(comunicacion.tarea_liviana.trabajador.perfil_url, "\" target=\"_blank\" class=\"text-dark\">").concat(comunicacion.tarea_liviana.trabajador.nombre, "</a></div>");
      } else {
        trabajador += "<span class=\"badge badge-danger\">eliminado</span>";
        status = '';
      }
      return $("\n\t\t\t<tr data-id=\"".concat(trabajador.id, "\">\n\t\t\t\t<td>\n\t\t\t\t\t").concat(trabajador, "\n\t\t\t\t</td>\n\t\t\t\t<td>").concat(comunicacion.email == null ? 'No fue cargado' : comunicacion.email, "</td>\n\t\t\t\t<td>").concat(comunicacion.tipo, "</td>\n\t\t\t\t<td>\n\t\t\t\t\t").concat(comunicacion.created_at_formatted, "\n\t\t\t\t</td>\n\t\t\t\t<td>\n\t\t\t\t\t").concat(status, "\n\t\t\t\t</td>\n\t\t\t</tr>"));
    }
  });
});
...
/***/ 47:
/*!*****************************************************************!*\
  !*** multi ./resources/js/empleados/comunicaciones_livianas.js ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\ela_g\Herd\ejornal_laravel\resources\js\empleados\comunicaciones_livianas.js */"./resources/js/empleados/comunicaciones_livianas.js");
