...
/***/ "./resources/js/empleados/nominas.js":
/*!*******************************************!*\
  !*** ./resources/js/empleados/nominas.js ***!
  \*******************************************/
/*! no exports provided */
    ...
    datatable_options: {
      ...
      columns: [{
        ...
        render: function render(v) {
          return "\n\t\t\t\t\t\t\t<div class=\"table-thumbnail\">\n\t\t\t\t\t\t\t\t<div class=\"image\" style=\"background-image:url(".concat(v.photo_url, ")\"></div>\n\t\t\t\t\t\t\t</div>");
        }
      }, {
        data: function data(row) {
          return row;
        ...
        render: function render(v) {
          return "<a class=\"text-dark\" href=\"".concat(v.perfil_url, "\">").concat(v.nombre, "</a>");
        }
      }, {
        data: 'email',
        name: 'email',
        ...
        className: 'align-middle border-left',
        render: function render(v) {
          return v.telefono == null ? '<span class="text-muted font-italic">[no cargado]</span>' : "<a class=\"text-dark\" href=\"tel:".concat(v.telefono, "\">").concat(v.telefono, "</a>");
        }
      }, {
        data: function data(row) {
          return row;
        ...
        render: function render(v) {
          ...
          return "".concat(v.fecha_nacimiento, "<br><small>Edad: ").concat(v.edad, "</small>");
        }
      }, {
        data: 'estado',
        name: 'estado',
        className: 'align-middle border-left text-center',
        render: function render(v) {
          return "<span class=\"badge badge-".concat(v == 1 ? 'success' : 'danger', "\">").concat(v == 1 ? 'activo' : 'inactivo', "</span>");
        }
      }, {
        data: 'sector',
        name: 'sector',
        ...
        render: function render(v) {
          ...
          var ausente = false;
          v.ausentismos.map(function (ausentismo) {
            if (ausentismo.ausente_hoy) {
              ausente = true;
              nombre = "<div class=\"small text-muted font-italic\">".concat(ausentismo.tipo.nombre, "</div>");
            }
          });
          if (ausente) {
            label = '<span class="badge badge-danger">ausente</span>';
          }
          return "".concat(label, " ").concat(nombre);
        }
      }, {
        data: 'created_at',
        name: 'created_at',
