...
/***/ "./resources/js/empleados/resumen.js":
/*!*******************************************!*\
  !*** ./resources/js/empleados/resumen.js ***!
  \*******************************************/
/*! no exports provided */
...
$(function () {
  var table_preocupacionales = new _classes_Tablas_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
    ...
    datatable_options: {
      ...
      columns: [{
        ...
        render: function render(v) {
          return "\n\t\t\t\t\t\t\t<div class=\"font-weight-bold\">".concat(v.trabajador.nombre, "<div>\n\t\t\t\t\t\t\t<div class=\"small\">DNI: ").concat(v.trabajador.dni, "</div>\n\t\t\t\t\t\t\t<div class=\"small\">Tel: ").concat(v.trabajador.telefono, "</div>\n\n\t\t\t\t\t\t\t").concat(v.trabajador_cliente != v.id_cliente ? "<span class=\"badge badge-dark\">transferido</span>" : '', "\n\t\t\t\t\t\t");
        }
      }, {
        data: 'fecha',
        name: 'fecha',
        ...
        render: function render(v) {
          ...
          return "\n\t\t\t\t\t\t\t<div>".concat(v.fecha_vencimiento, "</div>\n\t\t\t\t\t\t\t").concat(v.estado_vencimiento_label, "\n\t\t\t\t\t\t");
        }
      },
      /*{
      ...
      },*/
      {
        ...
        render: function render(v, type, row, meta) {
          ...
          var buttons = '';
          v.archivos.map(function (archivo, k) {
            buttons += "<div class=\"flex flex-wrap\">\n\t\t\t\t\t\t\t\t<button data-toggle=\"open-file\" class=\"btn btn-info btn-tiny mr-3 mb-1\" data-href=\"".concat(archivo.file_path, "\" title=\"").concat(archivo.archivo, "\" >\n\t\t\t\t\t\t\t\t\t<i class=\"fa fa-download fa-fw\"></i> <span>").concat(archivo.archivo, "</span>\n\t\t\t\t\t\t\t\t</button>\n\t\t\t\t\t\t\t</div>");
          });
          return buttons;
        }
      }, {
        ...
        render: function render(v, type, row, meta) {
          if (meta.settings.json.fichada_user != 1 && meta.settings.json.fichar_user) return '<span class="text-muted small font-italic">[debes fichar]</span>';
          return "\n\t\t\t\t\t\t<div class=\"acciones_tablax justify-content-endx\">\n\t\t\t\t\t\t\t<button data-toggle=\"completado\" data-id=\"".concat(v.id, "\" title=\"Marcar como completado\" class=\"btn btn-tiny tag_ejornal_success\" >\n\t\t\t\t\t\t\t\t<i class=\"fas fa-check\"></i> <span>Marcar como completado</span>\n\t\t\t\t\t\t\t</button>\n\t\t\t\t\t\t</div>");
        }
      }]
    }
  });
  $('[data-table="preocupacionales"]').on('click', '[data-toggle="open-file"]', function (btn) {
    var href = $(btn.currentTarget).attr('data-href');
    window.open(href);
  });
  $('[data-table="preocupacionales"]').on('click', '[data-toggle="completado"]', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(btn) {
      var id, tr, form_preocupacional, form;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            id = $(btn.currentTarget).attr('data-id');
            tr = $(btn.currentTarget).closest('tr');
            _context.n = 1;
            return axios.get("/templates/form-completar-preocupacional");
          case 1:
            form_preocupacional = _context.v;
            //return console.log(form_preocupacional.data)
            form = $(form_preocupacional.data);
  ...
  $('#popups').on('submit', '[data-form="completar-preocupacional"]', /*#__PURE__*/function () {
      ...
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          case 0:
            ...
            _context2.p = 1;
            _context2.n = 2;
            return axios.post("preocupacionales/completar", post);
          case 2:
            response = _context2.v;
            toastr.success(response.data.message);
            if (post.renovar_estudio == 1) {
              window.location.href = "/empleados/preocupacionales/create?renovar=1&id=".concat(post.id);
            } else {
...
/***/ 22:
/*!*************************************************!*\
  !*** multi ./resources/js/empleados/resumen.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\ela_g\Herd\ejornal_laravel\resources\js\empleados\resumen.js */"./resources/js/empleados/resumen.js");
