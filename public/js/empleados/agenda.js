...
/***/ "./resources/js/empleados/agenda.js":
/*!******************************************!*\
  !*** ./resources/js/empleados/agenda.js ***!
  \******************************************/
/*! no exports provided */
...
var Calendar = /*#__PURE__*/function () {
  ...
  return _createClass(Calendar, [{
    key: "modal_turno",
    value: function () {
      var _modal_turno = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        var data,
          promise,
          form,
          motivos,
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              ...
              _context.n = 1;
              return Promise.all([get_template('/templates/agendar-evento'), axios.get('/empleados/agenda_motivos')]);
            case 1:
              promise = _context.v;
              form = $(promise[0]);
              motivos = promise[1].data.data;
              form.find('[data-content="form-title"]').text(data == false ? 'Agendar Turno' : 'Editar Turno');
              if (motivos) {
                motivos.map(function (motivo) {
                  var option = window.dom('option');
              ...
              if (data) {
                ...
                form.find("[name=\"user_id\"] option[value=\"".concat(data.user.id, "\"]")).remove();
                form.find('[name="user_id"]').append("<option value=\"".concat(data.turno.user_id, "\" selected>").concat(data.turno.user.nombre, " (").concat(data.turno.user.especialidad.nombre, ")</option>"));
                form.find('[name="nomina_id"]').append("<option value=\"".concat(data.turno.nomina_id, "\" selected>").concat(data.turno.trabajador.nombre, "</option>"));
              ...
              form.find('[name="fecha_inicio"]').datepicker({
                dateFormat: 'dd/mm/yy'
              }).blur();
              ...
              form.find('[name="user_id"]').select2({
                ...
                ajax: {
                  ...
                  processResults: function processResults(response) {
                    return {
                      results: response.result.map(function (obj) {
                        return {
                          id: obj.id,
                          text: "".concat(obj.nombre, " (").concat(obj.especialidad.nombre, ")"),
      ...
      function modal_turno() {
        return _modal_turno.apply(this, arguments);
      }
      return modal_turno;
    }()
  }, {
    key: "ver_turno",
    value: function () {
      var _ver_turno = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(id) {
        var template;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.n) {
            case 0:
              _context2.n = 1;
              return axios.get("/empleados/agenda/ver-turno/".concat(id));
            case 1:
      ...
      function ver_turno(_x) {
        return _ver_turno.apply(this, arguments);
      }
      return ver_turno;
    }()
  }, {
    key: "proximos_turnos",
    value: function () {
      var _proximos_turnos = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        var turnos;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.n) {
            case 0:
              _context3.n = 1;
              return axios.post('/templates/proximos-turnos', {
                user: $('[name="usuarios"]').val(),
                trabajador: $('[name="trabajadores"]').val()
              });
            case 1:
              turnos = _context3.v;
      ...
      function proximos_turnos() {
        return _proximos_turnos.apply(this, arguments);
      }
      return proximos_turnos;
    }()
  }, {
    key: "modal_comunicacion",
    value: function () {
      var _modal_comunicacion = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(data) {
        var ausentismo, template, form;
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.n) {
            case 0:
              ///console.log(data)
              ausentismo = data.nomina.ausentismos[0];
              _context4.n = 1;
              return get_template('/templates/form-comunicacion');
            case 1:
              template = _context4.v;
              form = $(template);
              ...
              data.tipo_comunicaciones.map(function (tipo) {
      ...
      function modal_comunicacion(_x2) {
        return _modal_comunicacion.apply(this, arguments);
      }
      return modal_comunicacion;
    }()
  }, {
    key: "modal_turno_atendido",
    value: function () {
      var _modal_turno_atendido = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5(turno) {
        var user, consulta_title, swal, response_ausentismo, swal_sin_ausentismos, swal_consulta;
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.n) {
            ...
            case 1:
              ...
              consulta_title = user.data.especialidad.nombre == 'médico' ? 'Médica/Nutricional' : 'de Enfermería';
              _context5.n = 2;
              return Swal.fire({
                icon: 'question',
                allowOutsideClick: false,
                title: "\xBFDeseas cargar una Comunicaci\xF3n o Consulta ".concat(consulta_title, "?"),
                html: "<div class=\"small-comment\">Si seleccionas cargar una comunicaci\xF3n, el trabajador deber\xE1 tener un ausentismo vigente.</div>",
                input: 'select',
                inputOptions: {
                  'consulta': "Consulta ".concat(consulta_title),
            ...
            case 3:
              ...
              _context5.n = 4;
              return axios.get("/empleados/check-ausentismo/".concat(turno.nomina_id));
            case 4:
              response_ausentismo = _context5.v;
            ...
            case 5:
              swal_sin_ausentismos = _context5.v;
              return _context5.a(2, false);
            case 6:
              return _context5.a(2, this.modal_comunicacion(response_ausentismo.data));
            case 7:
            ...
            case 8:
              swal_consulta = _context5.v;
              if (!swal_consulta.isDenied) {
                _context5.n = 9;
                break;
              }
              return _context5.a(2, false);
            case 9:
              return _context5.a(2, window.location.href = "/empleados/consultas/".concat(swal_consulta.value, "/create?id_nomina=").concat(turno.nomina_id));
            case 10:
              if (!(user.data.especialidad.nombre == 'enfermero')) {
                _context5.n = 11;
                break;
              }
              return _context5.a(2, window.location.href = "/empleados/consultas/enfermeria/create?id_nomina=".concat(turno.nomina_id));
            case 11:
              return _context5.a(2);
          }
        }, _callee5, this);
      }));
      function modal_turno_atendido(_x3) {
        return _modal_turno_atendido.apply(this, arguments);
      }
      return modal_turno_atendido;
    }()
  }, {
    key: "modal_turno_sin_atender",
    value: function () {
      var _modal_turno_sin_atender = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6(turno) {
        var swal, response;
          ...
          while (1) switch (_context6.n) {
            case 0:
              ...
              return Swal.fire({
                icon: 'question',
                allowOutsideClick: false,
                title: "\xBFDeseas cargar un comentario u observaci\xF3n?",
                html: "<div class=\"small-comment\">Puedes describir los detalles del por qu\xE9 no fue atendido este trabajador.</div>",
                input: 'textarea',
            ...
            case 2:
              console.log(swal);
              _context6.n = 3;
              return axios.post("/empleados/agenda/editar-turno/".concat(turno.id), {
                mode: 'comentarios',
      ...
      function modal_turno_sin_atender(_x4) {
        return _modal_turno_sin_atender.apply(this, arguments);
      }
      return modal_turno_sin_atender;
    }()
  }, {
    key: "reload_calendar",
    value: function reload_calendar() {
    ...
    value: function init() {
      ...
      this.calendar = new _fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__["Calendar"](calendarEl, {
        ...
        eventSources: function () {
          var _eventSources = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7(view, element) {
            var s, e, response, events;
            return _regenerator().w(function (_context7) {
              while (1) switch (_context7.n) {
                case 0:
                  s = new Date(view.start.valueOf() + 3 * 60 * 60000);
                  e = new Date(view.end.valueOf() + 3 * 59 * 60000);
                  _context7.n = 1;
                  return axios.post('/empleados/agenda/buscar_turnos', {
                    from: s,
                    to: e,
                    user: $('[name="usuarios"]').val(),
                    trabajador: $('[name="trabajadores"]').val()
                ...
                case 1:
                  ...
                  events = [];
                  response.data.results.map(function (event) {
                    events.push({
                      id: event.id,
                      title: "".concat(event.trabajador.nombre),
                      start: event.fecha_inicio,
                      end: event.fecha_final,
                      classNames: ['calendar-event', event.estado.referencia]
                    });
                  });
                  return _context7.a(2, events);
              }
            }, _callee7);
          }));
          function eventSources(_x5, _x6) {
            return _eventSources.apply(this, arguments);
          }
          return eventSources;
        }(),
        eventClick: function () {
          var _eventClick = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8(info) {
            return _regenerator().w(function (_context8) {
              while (1) switch (_context8.n) {
                case 0:
                  ...
                  _this.ver_turno(info.event.id);
                case 1:
                  return _context8.a(2);
              }
            }, _callee8);
          }));
          function eventClick(_x7) {
            return _eventClick.apply(this, arguments);
          }
          return eventClick;
        }(),
        eventDrop: function () {
          var _eventDrop = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9(info) {
            var id, response, _t;
            return _regenerator().w(function (_context9) {
              while (1) switch (_context9.p = _context9.n) {
                case 0:
                  ...
                  _context9.p = 1;
                  _context9.n = 2;
                  return axios.post("/empleados/agenda/editar-turno/".concat(id), {
                    id: id,
      ...
      //////////////////
      $('[data-toggle="add-event"]').click(/*#__PURE__*/function () {
        var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee0(btn) {
      ...
      $('body').on('submit', '[data-form="agregar-turno"]', /*#__PURE__*/function () {
        var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1(form) {
          var post, status, response, _t2;
          return _regenerator().w(function (_context1) {
            while (1) switch (_context1.p = _context1.n) {
              case 0:
                form.preventDefault();
                post = get_form(form.currentTarget);
                status = $(form.currentTarget).find('[name="estado_id"] option:selected').attr('data-reference');
                _context1.p = 1;
                _context1.n = 2;
                return axios.post('/empleados/agenda/guardar_turno', post);
              case 2:
              ...
              case 3:
                ...
                $('#modals').modal('hide');
                _this.reload_calendar();

                /// Si fue atendido pregunto si desea cargar consulta o comunicación
                if (status == 'attended') {
                  _this.modal_turno_atendido(response.data.turno);
                }
                _context1.n = 5;
                break;
              case 4:
                ...
                _t2 = _context1.v;
                //console.log(error)
                toastr.error(_t2.response.data.message);
              case 5:
      ...
      $('body').on('click', '[data-toggle="cancelar-turno"]', /*#__PURE__*/function () {
        var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee10(btn) {
          var card, id, response, data, turno, user, swal, response_edit;
          return _regenerator().w(function (_context10) {
            while (1) switch (_context10.n) {
              case 0:
                card = $(btn.currentTarget).closest('.timeline-card');
                id = card.attr('data-id');
                _context10.n = 1;
                return axios.post("/empleados/agenda/turno/".concat(id));
              case 1:
              ...
              case 2:
                data = response.data;
                turno = data.turno;
                user = data.user; // Chequeo si el turno fue creado por el mismo usuario o está asignado a su usuario
      ...
      $('body').on('click', '[data-toggle="editar-turno"]', /*#__PURE__*/function () {
        var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee11(btn) {
          var card, id, response;
          return _regenerator().w(function (_context11) {
            while (1) switch (_context11.n) {
              ...
              case 1:
                ...
                _this.modal_turno(response.data);
              case 2:
      ...
      $('body').on('click', '[data-toggle="change-status"]', /*#__PURE__*/function () {
        var _ref5 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee12(btn) {
          var status, card, id, response;
          return _regenerator().w(function (_context12) {
            while (1) switch (_context12.n) {
              case 0:
                status = $(btn.currentTarget).attr('data-value');
                card = $(btn.currentTarget).closest('.timeline-card');
                id = card.attr('data-id'); //return console.log(status)
                _context12.n = 1;
                return axios.post("/empleados/agenda/editar-turno/".concat(id), {
                  mode: 'status',
                  status: status
              ...
              case 2:
                ...
                if (status == 'absent') {
                  _this.modal_turno_sin_atender(response.data.turno);
                }
              case 3:
      ...
      $('[name="usuarios"]').change(function (select) {
        _this.reload_calendar();
      });
      $('[name="trabajadores"]').change(function (select) {
        _this.reload_calendar();
      });
      this.sync_event = setInterval(this.proximos_turnos, this.delay_interval * 1000);
      this.proximos_turnos();
...
/***/ 23:
/*!************************************************!*\
  !*** multi ./resources/js/empleados/agenda.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! D:\work\ejornal\resources\js\empleados\agenda.js */"./resources/js/empleados/agenda.js");
