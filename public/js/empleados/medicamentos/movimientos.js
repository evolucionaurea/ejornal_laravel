...
/***/ "./resources/js/empleados/medicamentos/movimientos.js":
/*!************************************************************!*\
  !*** ./resources/js/empleados/medicamentos/movimientos.js ***!
  \************************************************************/
/*! no exports provided */
  ...
  new _classes_Tablas_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
    ...
    datatable_options: {
      ...
      columnDefs: [{
        targets: 3,
        width: '150px'
      } // ajustá el porcentaje/píxeles a gusto
      ],
      columns: [{
        data: null,
        ...
        render: function render(v) {
          if (v.motivo == null) {
            if (v.id_consulta_enfermeria != null) return "<span class=\"text-muted font-italic\">Suministrado en Enfermer\xEDa</span>";
            if (v.id_consulta_medica != null) return "<span class=\"text-muted font-italic\">Suministrado en Consulta M\xE9dica</span>";
...
module.exports = __webpack_require__(/*! C:\Users\ela_g\Herd\ejornal_laravel\resources\js\empleados\medicamentos\movimientos.js */"./resources/js/empleados/medicamentos/movimientos.js");
