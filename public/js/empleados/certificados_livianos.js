...
/***/ "./resources/js/empleados/certificados_livianos.js":
/*!*********************************************************!*\
  !*** ./resources/js/empleados/certificados_livianos.js ***!
  \*********************************************************/
/*! no exports provided */
...
$(function () {
  new _classes_Tablas_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
    ...
    render_row: function render_row(certificado) {
      var trabajador = "<div>".concat(certificado.nombre, "</div>");
      if (certificado.tarea_liviana.trabajador.deleted_at == null) {
        trabajador = "<div><a href=\"".concat(certificado.tarea_liviana.trabajador.perfil_url, "\" target=\"_blank\" class=\"text-dark\">").concat(certificado.tarea_liviana.trabajador.nombre, "</a></div>");
      } else {
        trabajador += "<span class=\"badge badge-danger\">eliminado</span>";
      }
      return $("\n\t\t\t\t<tr data-id=\"".concat(trabajador.id, "\" >\n\t\t\t\t\t<td>\n\t\t\t\t\t\t<div>").concat(trabajador, "</div>\n\t\t\t\t\t\t").concat(certificado.id_cliente != certificado.trabajador_cliente ? "<span class=\"badge badge-dark\">transferido</span>" : '', "\n\t\t\t\t\t</td>\n\t\t\t\t\t<td>").concat(certificado.medico, "</td>\n\t\t\t\t\t<td>").concat(certificado.institucion, "</td>\n\t\t\t\t\t<td>").concat(certificado.fecha_inicio, "</td>\n\t\t\t\t\t<td>").concat(certificado.fecha_final, "</td>\n\t\t\t\t\t<td>").concat(certificado.fecha_regreso_trabajar == null ? 'no cargada' : certificado.fecha_regreso_trabajar, "</td>\n\t\t\t\t\t<td>").concat(certificado.matricula_nacional == null ? 'no cargada' : certificado.matricula_nacional, "</td>\n\t\t\t\t</tr>"));
    }
  });
});
...
/***/ 41:
/*!***************************************************************!*\
  !*** multi ./resources/js/empleados/certificados_livianos.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\ela_g\Herd\ejornal_laravel\resources\js\empleados\certificados_livianos.js */"./resources/js/empleados/certificados_livianos.js");
