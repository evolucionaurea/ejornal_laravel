...
/***/ "./resources/js/empleados/medicamentos.js":
/*!************************************************!*\
  !*** ./resources/js/empleados/medicamentos.js ***!
  \************************************************/
/*! no exports provided */
...
$(function () {
  new _classes_Tablas_js__WEBPACK_IMPORTED_MODULE_0__["default"](_defineProperty({
    ...
    columns: [{
      ...
      render: function render(v, type, row, meta) {
        ...
        return "\n\t\t\t\t\t\t\t<div class=\"acciones_tabla justify-content-end\">\n\t\t\t\t\t\t\t\t<button class=\"editar_stock_medicamentos\" title=\"Egreso del medicamento\" data-toggle=\"modal\" data-target=\"#editar_stock_medicamentos\" href=\"#\" data-info=\"".concat(v.id, "\">\n\t\t\t\t\t\t\t\t\t<i class=\"fas fa-minus\"></i>\n\t\t\t\t\t\t\t\t</button>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t");
      }
    }]
  }));
  ...
  $('[data-table="movimientos-medicamentos"]').on('click', '.editar_stock_medicamentos', function (btn) {
    var id = $(btn.currentTarget).attr('data-info');
    var tr = $(btn.currentTarget).closest('tr');
    var medicamento = tr.find('td:first-of-type').text();
    $('#editar_stock_medicamentos_titulo').find('[data-content="medicamento"]').text(medicamento);
    $('.form_editar_stock_medicamentos').attr('action', "medicamentos/".concat(id));
  });
});
...
/***/ 57:
/*!******************************************************!*\
  !*** multi ./resources/js/empleados/medicamentos.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\ela_g\Herd\ejornal_laravel\resources\js\empleados\medicamentos.js */"./resources/js/empleados/medicamentos.js");
