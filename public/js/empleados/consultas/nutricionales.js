...
/***/ "./resources/js/empleados/consultas/nutricionales.js":
/*!***********************************************************!*\
  !*** ./resources/js/empleados/consultas/nutricionales.js ***!
  \***********************************************************/
/*! no exports provided */
    ...
    datatable_options: {
      ...
      columns: [{
        ...
        render: function render(v) {
          ...
          var eliminado = v.deleted_at !== null && v.deleted_at !== undefined;
          var badge = eliminado ? '<span class="badge badge-danger ml-2">Eliminado</span>' : '';
          var nombre = v.nombre;
          return "\n\t\t\t\t\t<div>".concat(nombre, " ").concat(badge, "</div>\n\t\t\t\t\t<div class=\"small\">DNI: ").concat((_v$dni = v.dni) !== null && _v$dni !== void 0 ? _v$dni : '-', "</div>\n\t\t\t\t\t");
        }
      }, {
        className: 'align-middle',
        name: 'legajo',
        ...
        render: function render(v) {
          ...
          var eliminado = v.deleted_at !== null && v.deleted_at !== undefined;
          var legajoTxt = v.legajo == null ? '<span class="text-muted font-italic">[Sin legajo]</span>' : v.legajo;
          return "\n\t\t\t\t\t<div>\n\t\t\t\t\t\t".concat(legajoTxt, "\n\t\t\t\t\t\t").concat(eliminado ? '<span class="badge badge-danger ml-2">Eliminado</span>' : '', "\n\t\t\t\t\t</div>\n\t\t\t\t\t");
        }
      }, {
        className: 'align-middle',
        name: 'tipo',
...
/***/ 51:
/*!*****************************************************************!*\
  !*** multi ./resources/js/empleados/consultas/nutricionales.js ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\ela_g\Herd\ejornal_laravel\resources\js\empleados\consultas\nutricionales.js */"./resources/js/empleados/consultas/nutricionales.js");
