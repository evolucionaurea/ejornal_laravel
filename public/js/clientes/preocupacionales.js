...
/***/ "./resources/js/clientes/preocupacionales.js":
/*!***************************************************!*\
  !*** ./resources/js/clientes/preocupacionales.js ***!
  \***************************************************/
/*! no exports provided */
...
$(function () {
  new _classes_Tablas_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
    controller: '/clientes/preocupacionales',
    get_path: '/busqueda',
    delete_path: '/destroy',
      ...
      },*/
      {
        ...
        render: function render(archivos, type, row, meta) {
          ...
          archivos.map(function (archivo, k) {
            buttons += "<div class=\"flex flex-wrap\">\n\t\t\t\t\t\t\t\t<button data-toggle=\"open-file\" class=\"btn btn-info btn-tiny mr-3 mb-1\" data-href=\"".concat(archivo.file_path_cliente, "\" title=\"").concat(archivo.archivo, "\" >\n\t\t\t\t\t\t\t\t\t<i class=\"fa fa-download fa-fw\"></i> <span>").concat(archivo.archivo, "</span>\n\t\t\t\t\t\t\t\t</button>\n\t\t\t\t\t\t\t</div>");
          });
          return buttons;
        }
      }, {
...
/***/ 70:
/*!*********************************************************!*\
  !*** multi ./resources/js/clientes/preocupacionales.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\ela_g\Herd\ejornal_laravel\resources\js\clientes\preocupacionales.js */"./resources/js/clientes/preocupacionales.js");
