...
/***/ "./resources/js/admin/reportes/certificaciones.js":
/*!********************************************************!*\
  !*** ./resources/js/admin/reportes/certificaciones.js ***!
  \********************************************************/
/*! no exports provided */
      ...
      columns: [{
        ...
        render: function render(v) {
          ...
          v.map(function (doc) {
            ...
            var el = "\n\t\t\t\t\t\t\t<div class=\"mb-3\">\n\t\t\t\t\t\t\t\t<div class=\"mb-1 small\">\n\t\t\t\t\t\t\t\t\t<b>Instituci\xF3n</b>: ".concat(doc.institucion, " -\n\t\t\t\t\t\t\t\t\t<b>M\xE9dico</b>: ").concat(doc.medico, " -\n\t\t\t\t\t\t\t\t\t<b>Matr\xEDcula Nacional</b>: ").concat(doc.matricula_nacional, " -\n\t\t\t\t\t\t\t\t\t<b>Matr\xEDcula Provincial</b>: ").concat(doc.matricula_provincial, " -\n\t\t\t\t\t\t\t\t\t<b>Fecha documento</b>: ").concat(doc.fecha_documento, "\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t");
            doc.archivos.map(function (archivo) {
              el += "<a class=\"small text-success d-block\" target=\"_blank\" href=\"documentacion_ausentismo/descargar/".concat(doc.id, "\"><i class=\"fa fa-download fa-fw\"></i> ").concat(archivo.archivo, "</a>");
            });
            el += "</div>";
            docs.push(el);
          });
...
/***/ 15:
/*!**************************************************************!*\
  !*** multi ./resources/js/admin/reportes/certificaciones.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\ela_g\Herd\ejornal_laravel\resources\js\admin\reportes\certificaciones.js */"./resources/js/admin/reportes/certificaciones.js");
