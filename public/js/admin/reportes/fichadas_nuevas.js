...
var Tablas = /*#__PURE__*/function () {
  ...
  return _createClass(Tablas, [{
    ...
    value: function dt_server_side() {
      ...
      datatable_options.fnDrawCallback = function (settings) {
        loading({
          show: false
        });
      ...
      this.datatable_instance = new datatables_net_dt__WEBPACK_IMPORTED_MODULE_0__["default"](this.table, window.datatable_options);
      return true;
    }
  }, {
    key: "get",
