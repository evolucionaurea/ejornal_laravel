...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/datatables.net-dt/node_modules/jquery/dist/jquery.js");
/* harmony import */ var datatables_net__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! datatables.net */ "./node_modules/datatables.net/js/dataTables.js");
...
/***/ "./node_modules/datatables.net-dt/node_modules/jquery/dist/jquery.js":
/*!***************************************************************************!*\
  !*** ./node_modules/datatables.net-dt/node_modules/jquery/dist/jquery.js ***!
  \***************************************************************************/
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! DataTables 2.3.7
 * © SpryMedia Ltd - datatables.net/license
 */
...
(function( factory ) {
	...
	if ( true ) {
		// AMD
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ "./node_modules/datatables.net/node_modules/jquery/dist/jquery.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function ( $ ) {
...
/***/ "./resources/js/admin/reportes/fichadas_nuevas.js":
/*!********************************************************!*\
  !*** ./resources/js/admin/reportes/fichadas_nuevas.js ***!
  \********************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _classes_Tablas_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../classes/Tablas.js */ "./resources/js/classes/Tablas.js");
...
$(function () {
  var table = new _classes_Tablas_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
    ...
    datatable_options: {
      ...
      columns: [{
        ...
        name: 'users.estado',
        render: function render(v) {
          return v.estado == 1 ? 'Activo' : 'Inactivo';
        }
      }, {
        className: 'align-middle',
        data: 'user',
  ...
  $('[data-table="fichadas"]').on('click', '[data-toggle="editar-fichada"]', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(btn) {
      var td, action, tr, id, fecha, empleado, promise, response, fichada, form, old_date_obj, old_month, old_day, old_date, i, option, hour, m, _option, minutes, swal;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            btn.preventDefault();
            td = $(btn.currentTarget).closest('td');
            action = $(btn.currentTarget).attr('data-action');
            tr = $(btn.currentTarget).closest('tr');
            id = tr.attr('data-id');
            fecha = td.find('span').text();
            empleado = tr.find('td:first-of-type').text(); //return console.log( oldDate, action, id )
            ...
            _context.n = 1;
            return Promise.all([get_template('/templates/form-cambiar-fichada'), axios.get("/admin/reportes/fichada_nueva/".concat(id))]);
          case 1:
            promise = _context.v;
            response = promise[0];
            fichada = promise[1].data;
            form = $(response);
            form.find('[data-content="current_date"]').text("".concat(action == 'ingreso' ? fichada.ingreso : fichada.egreso, " hs."));
            form.find('[data-content="empleado"]').text(fichada.user.nombre);
            old_date_obj = new Date(action == 'ingreso' ? fichada.ingreso_carbon : fichada.egreso_carbon);
            old_month = old_date_obj.getMonth() + 1;
            old_day = old_date_obj.getDate();
            old_date = "".concat(old_day < 10 ? '0' + old_day : old_day, "/").concat(old_month < 10 ? '0' + old_month : old_month, "/").concat(old_date_obj.getFullYear()); //console.log(old_date_obj.getHours())
            form.find('[name="new_date"]').val(old_date);
            form.find('[name="id"]').val(id);
            form.find('[name="action"]').val(action);
            for (i = 0; i <= 23; i++) {
              option = dom('option');
              hour = i < 10 ? "0".concat(i) : i;
              option.val(hour).text(hour);
              if (i == old_date_obj.getHours()) option.attr({
                selected: true
              });
            ...
            for (m = 0; m <= 59; m++) {
              _option = dom('option');
              minutes = m < 10 ? "0".concat(m) : m;
              _option.val(minutes).text(minutes);
              if (m == old_date_obj.getMinutes()) _option.attr({
                selected: true
              });
              form.find('[name="new_minutes"]').append(_option);
            }
            _context.n = 2;
            return Swal.fire({
              title: 'Editar Fecha',
  ...
  $('body').on('submit', '[data-form="cambiar-fichada"]', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(form) {
      ...
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          case 0:
            ...
            _context2.p = 1;
            _context2.n = 2;
            return axios.post('/admin/reportes/cambiar_fichada', post);
          case 2:
...
/***/ "./resources/js/classes/Tablas.js":
/*!****************************************!*\
  !*** ./resources/js/classes/Tablas.js ***!
  \****************************************/
/*! exports provided: default */
...
var Tablas = /*#__PURE__*/function () {
  ...
  return _createClass(Tablas, [{
    key: "set_filters",
    value: function set_filters() {
      if (!('modulo_busqueda' in this)) return true;
      var filters = {};
      $.each(this.modulo_busqueda.find('[name]'), function (k, v) {
    ...
    key: "filters_params",
    value: function filters_params() {
      var filters = this.set_filters();
      var query_string = Object.keys(filters).map(function (key) {
        return "".concat(encodeURIComponent(key), "=").concat(encodeURIComponent(filters[key]));
      }).join('&');
      return query_string;
    }
  }, {
    key: "dt_server_side",
    value: function dt_server_side() {
      var _this = this;
      ...
      this.datatable_options.ajax = {
        url: "".concat(this.controller).concat(this.get_path),
        type: 'POST',
        data: function data(d) {
          d._token = csfr;
          $.extend(d, _this.set_filters());
          //console.log(d)
          loading();
        }
      };
      this.datatable_options.fnDrawCallback = function (settings) {
        loading({
          show: false
        });
      };
      this.datatable_options.createdRow = function (row, data, dataIndex) {
      ...
      this.datatable_instance = new datatables_net_dt__WEBPACK_IMPORTED_MODULE_0__["default"](this.table[0], window.datatable_options);
      return true;
    }
  }, {
    key: "get",
    value: function get() {
      ...
      return new Promise(function (resolve, reject) {
        axios.post("".concat(_this2.controller).concat(_this2.get_path), _this2.set_filters()).then(function (response) {
    ...
    value: function _delete(id) {
      var _this3 = this;
      return new Promise(function (resolve, reject) {
        axios.post("".concat(_this3.controller).concat(_this3.delete_path, "/").concat(id), {
          _method: 'DELETE',
          _token: csfr
    ...
    key: "render_table",
    value: function render_table(data) {
      var _this4 = this;
      // apagar loader
      loading({
        show: false
      ...
      var opts = $.extend(true, {}, window.datatable_options || {}, this.datatable_options || {}, {
        destroy: true // permite reiniciar sin warnings
      });
      this.datatable_instance = new datatables_net_dt__WEBPACK_IMPORTED_MODULE_0__["default"](this.table[0], opts);
    }
  }, {
    key: "init",
    value: function init() {
      ...
      if (this.table.attr('id') == undefined) {
        var rand_id = "table_".concat(window.random(1111, 9999));
        this.table.attr('id', rand_id);
      }
      this.table_id = this.table.attr('id');

      /*Borrar*/
      this.table.on('click', '[data-toggle="delete"]', /*#__PURE__*/function () {
        var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(btn) {
          var tr, tr_prev, id, swal_warn, response;
          return _regenerator().w(function (_context) {
            while (1) switch (_context.n) {
              case 0:
                tr = $(btn.currentTarget).closest('tr');
                if (tr.hasClass('child')) {
                  tr_prev = $(btn.currentTarget).closest('tr').prev();
                  if (tr_prev.hasClass('parent')) tr = tr_prev;
                }
                id = tr.attr('data-id');
                _context.n = 1;
                return SwalWarning.fire({
                  title: 'delete_message' in _this5 ? _this5.delete_message : '¿Seguro deseas borrar este item?'
                });
              case 1:
                swal_warn = _context.v;
                if (swal_warn.value) {
                  _context.n = 2;
                  break;
                }
      ...
      if ('modulo_busqueda' in this) {
        ...
        /*Mostrar Todo*/
        this.modulo_busqueda.find('[data-toggle="clear"]').click(function (btn) {
          btn.preventDefault();
          _this5.modulo_busqueda.find('[name]').not('[data-toggle="no-reset"]').val('');
          _this5.modulo_busqueda.find('[data-toggle="search"]').trigger('click');
        });

        /*Buscar*/
        this.modulo_busqueda.find('[data-toggle="search"]').click(/*#__PURE__*/function () {
          var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(btn) {
            ...
            return _regenerator().w(function (_context2) {
              while (1) switch (_context2.n) {
                ...
                case 1:
                  response = _context2.v;
                  _this5.render_table(response);
                  _context2.n = 3;
                  break;
                case 2:
                  _this5.datatable_instance.ajax.reload();
                case 3:
                  return _context2.a(2);
              }
            }, _callee2);
        ...
        this.modulo_busqueda.on('keyup', '[name="search"]', function (input) {
          if (input.keyCode == 13) _this5.modulo_busqueda.find('[data-toggle="search"]').trigger('click');
        });

        /*Exportar*/
        this.modulo_busqueda.find('[data-toggle="export"]').click(/*#__PURE__*/function () {
          var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(btn) {
            var href, filters, query_string;
            return _regenerator().w(function (_context3) {
              while (1) switch (_context3.n) {
                case 0:
                  href = $(btn.currentTarget).attr('data-href');
                  filters = _this5.set_filters();
                  query_string = Object.keys(filters).map(function (key) {
                    return "".concat(encodeURIComponent(key), "=").concat(encodeURIComponent(filters[key]));
                  }).join('&');
                  window.open("".concat(href, "?").concat(query_string), '_blank');
                case 1:
        ...
        this.table.on('click', 'a', function (btn) {
          btn.preventDefault();
          var url = $(btn.currentTarget).attr('href');
          window.location.href = "".concat(url, "?").concat(_this5.filters_params());
        });
      } else {
        if (!('server_side' in this)) {
          this.get().then(function (response) {
            return _this5.render_table(response);
          });
        }
      }
    }
...
/***/ 18:
/*!**************************************************************!*\
  !*** multi ./resources/js/admin/reportes/fichadas_nuevas.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\ela_g\Herd\ejornal_laravel\resources\js\admin\reportes\fichadas_nuevas.js */"./resources/js/admin/reportes/fichadas_nuevas.js");
