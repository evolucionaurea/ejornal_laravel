...
/***/ "./resources/js/admin/reportes/tareas_adecuadas.js":
/*!*********************************************************!*\
  !*** ./resources/js/admin/reportes/tareas_adecuadas.js ***!
  \*********************************************************/
/*! no exports provided */
    ...
    datatable_options: {
      ...
      columns: [{
        ...
        render: function render(v) {
          ...
          return "\n\t\t\t\t\t\t\t<div>".concat(v.trabajador.nombre, "</div>\n\t\t\t\t\t\t\t<div class=\"small\">DNI: ").concat(v.trabajador.dni, "</div>\n\t\t\t\t\t\t\t").concat(v.id_cliente != v.trabajador.id_cliente ? '<span class="badge badge-dark">transferido</span>' : '', "\n\t\t\t\t\t\t");
        }
      }, {
        data: 'cliente',
        className: 'align-middle',
        ...
        render: function render(data) {
          ...
          return "<div class=\"flex flex-wrap\">\n\t\t\t\t\t\t\t\t<button data-toggle=\"open-file\" class=\"btn btn-info btn-tiny mr-3 mb-1\" data-href=\"".concat(data.archivo_path_admin, "\" title=\"").concat(data.archivo, "\" >\n\t\t\t\t\t\t\t\t\t<i class=\"fa fa-download fa-fw\"></i> <span>descargar</span>\n\t\t\t\t\t\t\t\t</button>\n\t\t\t\t\t\t\t</div>");
        }
      }, {
        data: 'comunicacion',
        name: 'comunicacion',
        width: 280,
        render: function render(comunicacion) {
          var _comunicacion$tipo$no;
          return "\n\t\t\t\t\t\t\t<p><span class=\"font-weight-bold\">Res.:</span> ".concat((_comunicacion$tipo$no = comunicacion.tipo.nombre) !== null && _comunicacion$tipo$no !== void 0 ? _comunicacion$tipo$no : '[no indicado]', "</p>\n\t\t\t\t\t\t\t<div class=\"small font-italic\"><b>Obs.:</b> ").concat(comunicacion.descripcion, "</div>\n\t\t\t\t\t\t");
        }
      }]
    }
  });
  $('[data-table="tareas-livianas"]').on('click', '[data-toggle="open-file"]', function (btn) {
...
/***/ 20:
/*!***************************************************************!*\
  !*** multi ./resources/js/admin/reportes/tareas_adecuadas.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\ela_g\Herd\ejornal_laravel\resources\js\admin\reportes\tareas_adecuadas.js */"./resources/js/admin/reportes/tareas_adecuadas.js");
