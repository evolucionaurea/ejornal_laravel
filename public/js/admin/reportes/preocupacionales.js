...
/***/ "./resources/js/admin/reportes/preocupacionales.js":
/*!*********************************************************!*\
  !*** ./resources/js/admin/reportes/preocupacionales.js ***!
  \*********************************************************/
/*! no exports provided */
      ...
      columns: [{
        ...
        render: function render(archivos, type, row, meta) {
          ...
          archivos.map(function (archivo, k) {
            buttons += "<div class=\"flex flex-wrap\">\n\t\t\t\t\t\t\t\t<button data-toggle=\"open-file\" class=\"btn btn-info btn-tiny mr-3 mb-1\" data-href=\"".concat(archivo.file_path_admin, "\" title=\"").concat(archivo.archivo, "\" >\n\t\t\t\t\t\t\t\t\t<i class=\"fa fa-download fa-fw\"></i> <span>descargar archivo</span>\n\t\t\t\t\t\t\t\t</button>\n\t\t\t\t\t\t\t</div>");
          });
          return buttons;
        }
      }, {
        ...
        render: function render(v) {
          var _v$resultado;
          return "\n\t\t\t\t\t\t\t<p><span class=\"font-weight-bold\">Res.:</span> ".concat((_v$resultado = v.resultado) !== null && _v$resultado !== void 0 ? _v$resultado : '[no indicado]', "</p>\n\t\t\t\t\t\t\t<div class=\"small font-italic\"><b>Obs.:</b> ").concat(v.observaciones, "</div>\n\t\t\t\t\t\t");
        }
      }]
    }
  });
...
/***/ 19:
/*!***************************************************************!*\
  !*** multi ./resources/js/admin/reportes/preocupacionales.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\ela_g\Herd\ejornal_laravel\resources\js\admin\reportes\preocupacionales.js */"./resources/js/admin/reportes/preocupacionales.js");
