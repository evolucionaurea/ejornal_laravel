...
$(function () {
  new _classes_Tablas_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
    ...
    render_row: function render_row(medicamento) {
      return $("\n\t\t\t<tr data-id=\"".concat(medicamento.id, "\" >\n\t\t\t\t<td>").concat(medicamento.nombre, "</td>\n\t\t\t\t<td class=\"text-center\">").concat(medicamento.stock_total == 0 ? '[sin stock]' : medicamento.stock_total, "</td>\n\t\t\t\t<td class=\"text-center\">").concat(medicamento.suministrados_total, "</td>\n\n\n\t\t\t\t<td class=\"acciones_tabla\" scope=\"row\">\n\t\t\t\t\t<a title=\"Ver\" href=\"medicamentos/").concat(medicamento.id, "/edit\">\n\t\t\t\t\t\t<i class=\"fas fa-pencil\"></i>\n\t\t\t\t\t</a>\n\n\t\t\t\t\t<button data-toggle=\"delete\" data-id=\"").concat(medicamento.id, "\" title=\"Eliminar\" type=\"submit\">\n\t\t\t\t\t\t<i class=\"fas fa-trash\"></i>\n\t\t\t\t\t</button>\n\n\t\t\t\t</td>\n\t\t\t</tr>"));
    }
  });
});
