...
/***/ "./resources/js/admin/medicamentos.js":
/*!********************************************!*\
  !*** ./resources/js/admin/medicamentos.js ***!
  \********************************************/
/*! no exports provided */
...
$(function () {
  new _classes_Tablas_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
    ...
    get_path: '/busqueda',
    // axios.post => /admin/medicamentos/busqueda
    delete_path: '/destroy',
    // importante el "/"
    ...
    render_row: function render_row(medicamento) {
      var _medicamento$suminist;
      var eliminado = !!medicamento.cliente_eliminado;
      var trClass = eliminado ? 'fila-cliente-eliminado' : '';
      var badge = eliminado ? ' <span class="badge-eliminado">Cliente Eliminado</span>' : '';
      var stock = Number(medicamento.stock_total || 0);
      return $("\n        <tr class=\"".concat(trClass, "\" data-id=\"").concat(medicamento.id, "\">\n          <td>").concat(medicamento.nombre).concat(badge, "</td>\n          <td class=\"text-center\">").concat(stock <= 0 ? '[sin stock]' : stock, "</td>\n          <td class=\"text-center\">").concat((_medicamento$suminist = medicamento.suministrados_total) !== null && _medicamento$suminist !== void 0 ? _medicamento$suminist : 0, "</td>\n          <td class=\"acciones_tabla\" scope=\"row\">\n            <a title=\"Ver\" href=\"/admin/medicamentos/").concat(medicamento.id, "/edit\">\n              <i class=\"fas fa-pencil\"></i>\n            </a>\n\n            <button data-toggle=\"delete\" data-id=\"").concat(medicamento.id, "\" title=\"Eliminar\" type=\"button\">\n              <i class=\"fas fa-trash\"></i>\n            </button>\n          </td>\n        </tr>\n      "));
    }
  });
});
...
/***/ 5:
/*!**************************************************!*\
  !*** multi ./resources/js/admin/medicamentos.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\ela_g\Herd\ejornal_laravel\resources\js\admin\medicamentos.js */"./resources/js/admin/medicamentos.js");
