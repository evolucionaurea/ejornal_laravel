...
/***/ "./resources/js/admin/clientes.js":
/*!****************************************!*\
  !*** ./resources/js/admin/clientes.js ***!
  \****************************************/
/*! no exports provided */
...
$(function () {
  $(".restaurar_cliente").on("click", function (btn) {
    $("input[name='id_cliente']").val($(btn.currentTarget).attr('data-info'));
  });
  new datatables_net_dt__WEBPACK_IMPORTED_MODULE_0__["default"]('[data-table="clientes"]', window.datatable_options);
});
...
/***/ 8:
/*!**********************************************!*\
  !*** multi ./resources/js/admin/clientes.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\ela_g\Herd\ejornal_laravel\resources\js\admin\clientes.js */"./resources/js/admin/clientes.js");
