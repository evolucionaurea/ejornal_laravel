...
$(function () {
  new _classes_Tablas_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
    ...
    render_row: function render_row(user) {
      var clientes = [];
      var grupo = '';
      user.clientes_user.map(function (cliente) {
      ...
      console.log(user);
      return $("\n\t\t\t<tr data-id=\"".concat(user.id, "\">\n\t\t\t\t<td>").concat(user.nombre, "</td>\n\t\t\t\t<td>").concat(user.email, "</td>\n\t\t\t\t<td>").concat(user.especialidad != null ? user.especialidad.nombre : '', "</td>\n\t\t\t\t<td><span class=\"badge badge-").concat(user.estado == 1 ? 'success' : 'danger', "\">").concat(user.estado == 1 ? 'Activo' : 'Inactivo', "</span></td>\n\t\t\t\t<td>\n\t\t\t\t\t<span class=\"badge badge-").concat(user.fichar == 1 ? 'success' : 'danger', "\">").concat(user.fichar == 1 ? 'Si' : 'No', "</span>\n\t\t\t\t</td>\n\t\t\t\t<td style=\"width:420px\">\n\t\t\t\t\t<div><b>").concat(user.rol.nombre.capitalize(), "</b></div>\n\t\t\t\t\t<div class=\"small text-muted font-italic\" style=\"line-height:1.15\">").concat(clientes.join(', '), "</div>\n\t\t\t\t\t<div class=\"small text-muted font-italic\">").concat(grupo, "</div>\n\t\t\t\t</td>\n\n\t\t\t\t<td class=\"acciones_tabla\" scope=\"row\">\n\t\t\t\t\t<a title=\"Ver\" href=\"users/").concat(user.id, "/edit\">\n\t\t\t\t\t\t<i class=\"fas fa-pencil\"></i>\n\t\t\t\t\t</a>\n\n\t\t\t\t\t<button data-toggle=\"delete\" data-id=\"").concat(user.id, "\" title=\"Eliminar\" type=\"submit\">\n\t\t\t\t\t\t<i class=\"fas fa-trash\"></i>\n\t\t\t\t\t</button>\n\n\t\t\t\t</td>\n\t\t\t</tr>"));
    }
  });
});
...
module.exports = __webpack_require__(/*! C:\Users\ela_g\Herd\ejornal_laravel\resources\js\admin\users.js */"./resources/js/admin/users.js");
