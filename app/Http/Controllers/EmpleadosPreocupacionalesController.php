...
class EmpleadosPreocupacionalesController extends Controller
{
    ...
    public function index()
    {
      ...
      ->select('nominas.nombre', 'nominas.email', 'nominas.telefono', 'preocupacionales.fecha', 'preocupacionales.archivo', 'preocupacionales.id')
      ->get();
      ...
      return view('empleados.preocupacionales', compact('preocupacionales', 'clientes'));
